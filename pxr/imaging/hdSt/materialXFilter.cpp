...
/// @COLOR_MATERIAL do we need to add the default source color space? Isn't lin_rec709 sufficient?
...
/// @COLOR_MATERIAL do we conform these to render color space here?
